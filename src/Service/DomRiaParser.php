...
//    }
     ...
     * @throws TransportExceptionInterface
     */
    public function getAdById(string|int $id): array|bool
    {
        if (!empty($id)) {
     ...
     * @throws TransportExceptionInterface
     */
    public function searchAds(array $params): bool|array
    {
     ...
     * @throws TransportExceptionInterface
     */
    public function getAveragePrice(array $params): bool|array
    {
        if (isset($params['category']) && isset($params['sub_category']) && isset($params['operation'])) {
